...
The Social Media Blog Platform uses MongoDB as the primary database with Mongoose ODM for schema definition and validation. The database is designed for scalability, performance, and data integrity.
...
const findUserById = (id) => {
  return User.findById(id)
    ...
    .lean(); // Returns plain JavaScript object for better performance
};

...
const getPostAnalytics = asyncHandler(async (req, res) => {
	...
	try {
		const analytics = await safeAsyncOperation(() => AnalyticsService.getPostAnalytics(id, userId), null, true);
...
const cancelScheduledPost = asyncHandler(async (req, res) => {
	...
	try {
		const result = await safeAsyncOperation(() => SchedulerService.cancelScheduledPost(id, userId), null, true);
...
const reschedulePost = asyncHandler(async (req, res) => {
	...
	try {
		...
		const result = await safeAsyncOperation(() => SchedulerService.reschedulePost(id, userId, scheduledAt), null, true);

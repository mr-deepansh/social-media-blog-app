	...
	static async registerUser(userData, req) {
		...
		if (existingEmail && existingUsername) {
			throw new ApiError(409, "Both username and email are already registered", {
				...
				suggestions: ["Try a different username and email", "Login if you already have an account"]
			});
		}
		...
		if (existingUsername) {
			throw new ApiError(409, "Username is already taken", {
				conflicts: ["username"],
				suggestions: ["Choose a different username", "Try adding numbers or underscores"]
			});
		}

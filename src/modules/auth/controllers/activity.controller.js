...
const getLoginLocations = asyncHandler(async (req, res) => {
	...
	res.status(200).json(new ApiResponse(200, locations, "Login locations retrieved successfully"));
});
...
const getLocationAnalytics = asyncHandler(async (req, res) => {
	...
	res.status(200).json(new ApiResponse(200, analytics, "Location analytics retrieved successfully"));
});

export { getUserActivity, getActivityStats, getLoginLocations, getLocationAnalytics };

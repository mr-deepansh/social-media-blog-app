		...
		activityLog: [
			{
				action: {
					type: String,
					enum: ["login", "logout", "register", "password_reset", "profile_update", "email_change"],
					required: true,
				},
				timestamp: {
					type: Date,
...
userSchema.methods.addActivityLog = function (action, deviceInfo, location, success = true, errorMessage = null) {

...
const getSuspiciousAccounts = asyncHandler(async (req, res) => {
  ...
  return res
    .status(200)
    .json(new ApiResponse(200, result, "Suspicious accounts retrieved"));
});
...
const getLoginAttempts = asyncHandler(async (req, res) => {
  ...
  return res
    .status(200)
    .json(new ApiResponse(200, result, "Login attempts retrieved"));
});
...
const blockIpAddress = asyncHandler(async (req, res) => {
  ...
  return res
    .status(200)
    .json(new ApiResponse(200, result, "IP address blocked successfully"));
});
...
const getBlockedIps = asyncHandler(async (req, res) => {
  ...
  return res
    .status(200)
    .json(new ApiResponse(200, result, "Blocked IPs retrieved"));
});
...
const getThreatDetection = asyncHandler(async (req, res) => {
  ...
  return res
    .status(200)
    .json(new ApiResponse(200, threats, "Threat detection summary"));
});
...
const togglePostVisibility = asyncHandler(async (req, res) => {
  ...
  return res
    .status(200)
    .json(new ApiResponse(200, result, `Post ${action} successfully`));
});
...
const getAppSettings = asyncHandler(async (req, res) => {
  ...
  return res
    .status(200)
    .json(new ApiResponse(200, config, "App settings retrieved"));
});
...
const updateAppSettings = asyncHandler(async (req, res) => {
  ...
  return res
    .status(200)
    .json(new ApiResponse(200, result, "App settings updated"));
});
...
const getNotificationTemplates = asyncHandler(async (req, res) => {
  ...
  return res
    .status(200)
    .json(new ApiResponse(200, templates, "Notification templates retrieved"));
});
...
const sendBulkNotification = asyncHandler(async (req, res) => {
  ...
  return res
    .status(200)
    .json(new ApiResponse(200, result, "Bulk notification sent"));
});
...
const getServerHealth = asyncHandler(async (req, res) => {
  ...
  return res
    .status(200)
    .json(new ApiResponse(200, health, "Server health retrieved"));
});
...
const getDatabaseStats = asyncHandler(async (req, res) => {
  ...
  return res
    .status(200)
    .json(new ApiResponse(200, stats, "Database stats retrieved"));
});
...
const getAutomationRules = asyncHandler(async (req, res) => {
  ...
  return res
    .status(200)
    .json(new ApiResponse(200, rules, "Automation rules retrieved"));
});
...
const createAutomationRule = asyncHandler(async (req, res) => {
  ...
  return res
    .status(201)
    .json(new ApiResponse(201, rule, "Automation rule created"));
});
...
const getExperiments = asyncHandler(async (req, res) => {
  ...
  return res
    .status(200)
    .json(new ApiResponse(200, { experiments }, "Experiments retrieved"));
});
...
const createExperiment = asyncHandler(async (req, res) => {
  ...
  return res
    .status(201)
    .json(new ApiResponse(201, experiment, "Experiment created"));
});
...
const getRevenueAnalytics = asyncHandler(async (req, res) => {
  ...
  return res
    .status(200)
    .json(new ApiResponse(200, analytics, "Revenue analytics retrieved"));
});
...
const getUserLifetimeValue = asyncHandler(async (req, res) => {
  ...
  return res
    .status(200)
    .json(new ApiResponse(200, ltv, "User lifetime value retrieved"));
});

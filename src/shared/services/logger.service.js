...
const devFormat = printf(({ level, message, timestamp, stack, service, environment, version, ...meta }) => {
	...
	// Only show relevant meta data, skip common fields
	const filteredMeta = Object.keys(meta).length > 0 ? meta : null;
	if (filteredMeta) {
